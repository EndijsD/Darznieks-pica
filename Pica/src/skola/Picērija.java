...
int x = 1;
	...
	String tips() {
		Object[] opcijas = {"Home Alone", "Hawaiian", "Pepperoni", "Hungry Man", "Meat Lovers", "Supreme"};
		
		iznākumsObjektā = JOptionPane.showInputDialog(null, "Veids:", "Izvēlies picas tipu/veidu", JOptionPane.PLAIN_MESSAGE, null, opcijas, opcijas[0]);
	...
	double lielums() {
		...
		Object[] opcijas = {"Maza pica: 20-25 cm ar 6 šķēlēm - 11.65€", "Vidēja pica: 30 cm ar 8 šķēlēm - 14.15€",
							"Liela pica: 35 cm ar 10 šķēlēm - 18.31€", "Īpaši liela pica: 40-45 cm ar 12 šķēlēm - 19.98€"};
        iznākumsObjektā = JOptionPane.showInputDialog(null, "Izmērs:", "Izvēlies picas izmēru", JOptionPane.PLAIN_MESSAGE, null, opcijas, opcijas[0]);
	...
	double[] virskārtas() {
		...
		do {
	        ...
	        if(iznākumsVirskārtas != "Nevienu") {
		        ...
		        ja_ne = JOptionPane.showOptionDialog(null, "Vai vēlaties pievienot vēl kādu piedevu?", "Jautājums", 0, JOptionPane.QUESTION_MESSAGE, null, Pica.ja_ne, Pica.ja_ne[0]);
	        	i += 1;
	        } else
	        	cena += "0 ";
	...
	void rakstit() {
		...
		x = JOptionPane.showOptionDialog(null, "Atcerēties šo adresi?\n"+failaAtrasanasVieta, "Adrese", 0, JOptionPane.QUESTION_MESSAGE, null, Pica.ja_ne, Pica.ja_ne[0]);
		}
